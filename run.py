...
def main():
    if not sys.version_info >= (3, 5):
        ...
        if sys.platform.startswith('win'):
            print("Windows is not official supported yet. I'm not able to test windows\
             \ncompatibility and probably will not able  to fix issues. You are\
             \nstill free to post issues so I do what I can.") ####
            try:
